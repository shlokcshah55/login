...
class NoSavedLocationsPopover extends StatelessWidget {
  const NoSavedLocationsPopover({super.key});
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 18),
                    Text(
                      "You haven't saved any restaurants, search for them, import a list or share them from tiktok or instagram",
                      textAlign: TextAlign.center,
