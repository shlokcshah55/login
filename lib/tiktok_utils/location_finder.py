...
class LocationFinder:
    def __init__(self):
        ...
        self.gmaps = googlemaps.Client(key=os.getenv('GOOGLE_PLACE_API_KEY'))
    ...
    def parse_query(self, query: str) -> dict:
        ...
        prompt = f"""
        Analyze this location search query and extract key parameters in JSON format:
        {query}
    ...
    def get_coordinates(self, location_name: str):
        ...
        if location_name == "current_location":
            # Implement actual geolocation logic here
            return (51.5074, -0.1278)  # Default to London for demo
    ...
    def search_places(self, query: str) -> list:
        ...
        results = self.gmaps.places_nearby(**places_params)
...
if __name__ == "__main__":
    ...
    results = finder.search_places("Find a nice Italian restaurant in copehagen")
